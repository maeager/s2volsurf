...
set ylabel "# Log Normalised Image Values"
set xlabel "Normalised Image Values"
...
#set terminal x11
#set output "test.png"
plot for [col=2:4] filename every ::1 using 1:col title columnheader(col) with histeps ls 1
